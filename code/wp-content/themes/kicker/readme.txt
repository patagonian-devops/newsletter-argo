...
WordPress version: required at least 4.5, tested up to 5.5
...
Please install and activate it before starting to use the theme Kicker.
...
Theme documentation is available on http://kicker.axiomthemes.com/doc/
...
2) Icons (css/font-icons/*.*)
   The icon set used in Kicker is Fontello.
