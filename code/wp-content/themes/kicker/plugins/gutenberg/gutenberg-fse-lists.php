...
if ( ! function_exists( 'kicker_gutenberg_fse_list_header_styles' ) ) {
	 ...
	 * 
	 * Hooks: add_filter( 'kicker_filter_list_header_styles', 'kicker_gutenberg_fse_list_header_styles');
	 * 
	 * @param array $list  Optional. An array with a list of headers from other available Page Builders.
	 */
	function kicker_gutenberg_fse_list_header_styles( $list = array() ) {
		$new_list = array();
...
if ( ! function_exists( 'kicker_gutenberg_fse_list_footer_styles' ) ) {
	add_filter( 'kicker_filter_list_footer_styles', 'kicker_gutenberg_fse_list_footer_styles');
	/**
