...
if ( ! function_exists( 'kicker_trx_addons_get_css' ) ) {
	add_filter( 'kicker_filter_get_css', 'kicker_trx_addons_get_css', 10, 2 );
	function kicker_trx_addons_get_css( $css, $args ) {
