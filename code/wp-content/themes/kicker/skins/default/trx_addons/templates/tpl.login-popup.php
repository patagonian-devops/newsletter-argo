		...
		<div id="trx_addons_login_content" class="trx_addons_tabs_content trx_addons_login_content">
			<div class="trx_addons_tabs_content_wrap">
				<div class="logo">
					...
					?>
					<div><?php echo esc_html__('Log in to your account', 'kicker'); ?></div>
				</div>
				<div class="trx_addons_popup_form_wrap trx_addons_popup_form_wrap_login">
					<form class="trx_addons_popup_form trx_addons_popup_form_login <?php if ($trx_addons_form_style != 'default') echo 'sc_input_hover_'.esc_attr($trx_addons_form_style); ?>" action="<?php echo wp_login_url(); ?>" method="post" name="trx_addons_login_form">
						...
						<div class="trx_addons_popup_form_field trx_addons_popup_form_field_login">
							<label><?php echo esc_html__('Email Address or Login', 'kicker'); ?></label>
							<?php
							trx_addons_get_template_part(TRX_ADDONS_PLUGIN_SHORTCODES . 'form/tpl.form-field.php',
															...
															array(
																...
																'field_title' => esc_html__('Email or Login', 'kicker'),
																'field_placeholder' => esc_html__('Email or Login', 'kicker')
																)
														);
							?>
						</div>
						<div class="trx_addons_popup_form_field trx_addons_popup_form_field_password">
							<label><?php echo esc_html__('Password', 'kicker'); ?></label>
							<?php
							trx_addons_get_template_part(TRX_ADDONS_PLUGIN_SHORTCODES . 'form/tpl.form-field.php',
															'trx_addons_args_sc_form_field',
															array(
																...
																'field_title' => esc_html__('Password', 'kicker'),
																'field_placeholder' => esc_html__('Password', 'kicker')
																)
														);
							?>
						</div>
						<div class="trx_addons_popup_form_field remember_and_forgot">
							<div class="trx_addons_popup_form_field_remember">
								...
								<label for="rememberme"> <?php esc_html_e('Remember me', 'kicker'); ?></label>
							</div>
							<a href="<?php echo esc_url(wp_lostpassword_url(get_permalink())); ?>" class="trx_addons_popup_form_field_forgot_password"><?php esc_html_e('Forgot password?', 'kicker'); ?></a>
						</div>
						<div class="trx_addons_popup_form_field trx_addons_popup_form_field_submit">
							<button class="submit_button sc_button sc_button_default sc_button_size_normal sc_button_with_icon sc_button_icon_right hover_style_icon_1 color_style_1">
								...
								<span class="sc_button_text">
									<span class="sc_button_title"><?php esc_html_e('Login', 'kicker'); ?></span>
								</span><!-- /.sc_button_text -->
							</button>
						</div>
			...
			<?php if (!empty($trx_addons_login_via_socials)) { ?>
				<div class="trx_addons_tabs_content_wrap login_socials">
					<div class="trx_addons_login_socials_title"><?php esc_html_e('Or', 'kicker'); ?></div>
					<div class="trx_addons_login_socials_list">
						<?php trx_addons_show_layout($trx_addons_login_via_socials); ?>
					</div><?php
					if ( (int) get_option('users_can_register') != 0 ) { ?>
						<div class="trx_addons_tabs_title_register"><?php
							esc_html_e("Don't have a Times account?", 'kicker'); ?> 
							<a href="<?php echo esc_url(trx_addons_get_hash_link('#trx_addons_register_content')); ?>">	
								<?php esc_html_e('Create one', 'kicker'); ?>
							</a>
						</div>
			...
			<div id="trx_addons_register_content" class="trx_addons_tabs_content">
				<div class="trx_addons_tabs_content_wrap">
					<div class="logo">
						...
						get_template_part( apply_filters( 'kicker_filter_get_template_part', 'templates/header-logo' ) );
						?>
						<div><?php echo esc_html__('Register account', 'kicker'); ?></div>
					</div>
					<div class="trx_addons_popup_form_wrap trx_addons_popup_form_wrap_register">
						<form class="trx_addons_popup_form trx_addons_popup_form_register <?php if ($trx_addons_form_style != 'default') echo 'sc_input_hover_'.esc_attr($trx_addons_form_style); ?>" action="<?php echo wp_login_url(); ?>" method="post" name="trx_addons_login_form">
							...
							<div class="trx_addons_popup_form_field trx_addons_popup_form_field_login">
								<label><?php echo esc_html__('Login', 'kicker'); ?></label>
								<?php
								trx_addons_get_template_part(TRX_ADDONS_PLUGIN_SHORTCODES . 'form/tpl.form-field.php',
																'trx_addons_args_sc_form_field',
																array(
																	...
																	'field_req'   => true,
																	'field_icon'  => 'trx_addons_icon-user-alt',
																	'field_title' => esc_html__('Login', 'kicker'),
																	'field_placeholder' => esc_html__('Login', 'kicker')
																	)
															);
								?>
							</div>
							<div class="trx_addons_popup_form_field trx_addons_popup_form_field_email">
								<label><?php echo esc_html__('Email Address', 'kicker'); ?></label>
								<?php
								trx_addons_get_template_part(TRX_ADDONS_PLUGIN_SHORTCODES . 'form/tpl.form-field.php',
																'trx_addons_args_sc_form_field',
																array(
																	...
																	'field_placeholder' => esc_html__('E-mail', 'kicker')
																	)
															);
								?>
							</div>
							...
							<div class="trx_addons_popup_form_field trx_addons_popup_form_field_password">
								<label><?php echo esc_html__('Confirm Password', 'kicker'); ?></label>
								<?php
								trx_addons_get_template_part(TRX_ADDONS_PLUGIN_SHORTCODES . 'form/tpl.form-field.php',
																'trx_addons_args_sc_form_field',
																array(
																	...
																	'field_req'   => true,
																	'field_icon'  => 'trx_addons_icon-lock',
																	'field_title' => esc_html__('Confirm Password', 'kicker'),
																	'field_placeholder' => esc_html__('Confirm Password', 'kicker')
																	)
															);
								?>
							</div>
							...
							<div class="trx_addons_popup_form_field trx_addons_popup_form_field_submit">
								...
								?>">
									<span class="sc_button_text">
										<span class="sc_button_title"><?php echo esc_html('Sign Up', 'kicker'); ?></span>
									</span><!-- /.sc_button_text -->
								</button>
							</div>
							<div class="trx_addons_message_box sc_form_result"></div>
